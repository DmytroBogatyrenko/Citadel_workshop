...
from fastapi import APIRouter, Depends, Request, Cookie, File, Form, Response, Query
from fastapi.responses import RedirectResponse
from fastapi.security import OAuth2PasswordRequestForm
from sqlalchemy.ext.asyncio import AsyncSession
from sqlalchemy.future import select

from backend.config import templates, SECRET_KEY, ALGORITHM
from backend.dependencies import (
    get_session, get_current_user, get_current_user_optional,
    admin_required, build_user_context
)
from backend.project_models import (
    User, Problem, AdminResponse, ServiceRecord, Users_in_telegram, Review
)
